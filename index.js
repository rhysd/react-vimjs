...
exports["default"] = injectMdHighlight;

function injectMdHighlight() {
...
var _highlight_injector = require('./highlight_injector');

var _highlight_injector2 = _interopRequireDefault(_highlight_injector);
...
var VimMarkdown = (function (_React$Component) {
    _inherits(VimMarkdown, _React$Component);

    function VimMarkdown(props) {
        _classCallCheck(this, VimMarkdown);

        _get(Object.getPrototypeOf(VimMarkdown.prototype), 'constructor', this).call(this, props);
        this.state = { buffer: '' };
    }

    _createClass(VimMarkdown, [{
        ...
        value: function componentDidMount() {
            ...
            global.ReactVimJSExample.callback = function (buf) {
                _this.setState({ buffer: buf });
            };
        }
    }, {
        key: 'getVimrc',
        value: function getVimrc() {
        ...
        value: function render() {
            ...
            var props = {
                ...
                syntax: {
                    'markdown': (0, _highlight_injector2['default'])()
                }
            };
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    ...
                    _react2['default'].createElement('span', { dangerouslySetInnerHTML: { __html: (0, _marked2['default'])(this.state.buffer) } })
                )
            );
        }
    }]);
...
_react2['default'].render(_react2['default'].createElement(VimMarkdown, null), document.querySelector('.main'));

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./highlight_injector":1,"marked":4,"react":160,"react-vimjs":5}],3:[function(require,module,exports){
